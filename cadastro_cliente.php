        ...
        <div class="row"> 
            ...
            <div class="col-md-10"><!--CONTEUDO CENTRAL-->
                ...
                <div class="formulario col-md-6">
                    ...
                    <form class="form-editar center col-md-12" action="formularios/var_cadastro_cliente.php" method="POST">

                        <!--                        <div class="input-group input-group-lg">                            
                                                    <input class="form-control" name="marca" placeholder="Codigo" id="marca" type="text" onkeypress='return SomenteNumero(event)'>                                    
                                                    <span class="input-group-addon">
                                                        <i class="icon-form icon-code-barra"></i>
                                                    </span>                  
                                                </div>-->
                        <div class="input-group input-group-lg">                            
                        ...
                        <div class="input-group input-group-lg">
                            <input class="form-control" type="text" placeholder="Telefone" id="tel" name="tel" onkeypress="mascara(this, '(##) #####-####'); return SomenteNumero(event)">
                            <span class="input-group-addon">
